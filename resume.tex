...
\item Ruby on Rails, developing apps for Google Glass, modding video games, computational investing

\end{itemize} 

%Lopping this section off for now, just linking to Github.
...
%\item \ressubheading{World of Warcraft addon http://wow.curse.com/downloads/wow-addons/details/pimp.aspx}{Lua}{Lua script modifying the user interface of the game World of Warcraft helping %players optimize their characters optimally. Over four-hundred downloads to date. }{Summer 2011 - Ongoing}
